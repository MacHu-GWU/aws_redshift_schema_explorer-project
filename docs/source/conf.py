# -*- coding: utf-8 -*-
#
# aws_redshift_schema_explorer documentation build configuration file, created by
...
import aws_redshift_schema_explorer as package
...
# Add data for Jinja2
try:
    from aws_redshift_schema_explorer.docs import doc_data
except:
    doc_data = dict()
